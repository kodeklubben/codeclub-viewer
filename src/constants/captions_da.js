export default {
  ...
  frontpage: {
    ...
    teacherinfobox: {
      ...
      changemode: 'Er du ikke er en lærer eller veileder? Klikk elev / lærer-knappen i navigasjonsmenyen for å bytte modus. Du kan få mer informasjon ved å trykke på plusstegnet under',
      teacher: 'Lærer',
      info1: 'Sjekk ut våre filtre og oppgaveveiledninger. På venstre side kan du filtrere på ulike skole-fag, for å finne relevante oppgaver til din undervisning. Når du har huket av for fag så vil du kun se kun de oppgavene som våre lærere har vurdert som relevante, og du kan velge hvilket språk du vil undervise i. Hvert oppgavesett har en veiledning, og der finner du bl.a. hvilke konkrete læreplanmål man kan jobbe med i de ulike fagene.',

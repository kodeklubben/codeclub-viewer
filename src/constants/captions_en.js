...
<<<<<<< HEAD
    ...
    welcomebox: {
      ...
      info: 'Welcome to Kodeklubbens lesson pages! Here you will find many guides that you can use as inspiration to teach you programming and create your own games, apps and web pages. For beginners, we recommend taking a look at the block-based tasks in Code Studio or Scratch. Please use the filters on the left side to find tasks that are right for you!',
    ...
    teacherinfobox: {
      ...
      changemode: 'Are you not a teacher or supervisor? Click the student / teacher button in the navigation menu to switch mode. For more information, click the plus sign below',
      teacher: 'Teacher',
      info1: 'Check out our filters and tutorials. On the left side you can filter on different school subjects, to find relevant lessons for your teaching. Once you have finished checking for subjects, you will only see the lessons that our teachers have considered relevant and you can choose which language you want to teach. Each lesson set has a guide and you will find what specific curriculum goals you can work with in the various subjects.',
